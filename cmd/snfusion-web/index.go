...
func index_html() (*asset, error) {
	...
	info := bindata_file_info{name: "index.html", size: 6432, mode: os.FileMode(420), modTime: time.Unix(1455197567, 0)}
